...
import { activate as createComponentActivate, deactivate as createComponentDeactivate } from './modules/create-component';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  createComponentActivate(context);
}
